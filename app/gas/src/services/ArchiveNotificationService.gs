...
6月1日以降、前年度（${yearStart}年3月〜${yearEnd}年2月）のデータは
「過去データ」として別の場所に移動されます。編集は可能ですが、警告が表示されます。
...
対象期間: ${yearStart}年3月〜${yearEnd}年2月
...
■ 注意事項
  アーカイブされたデータは一部編集可能ですが、警告が表示されます。
  不明な点は開発担当までご連絡ください。
`;
